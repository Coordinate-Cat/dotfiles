...
## [0.3.1]
- [Fixed] Issue [#8](https://github.com/ArdenIvanov/svelte-intellisense/issues/8): Your extension is affected by event stream and have been blocked

## [0.3.0]
- [Fixed] Issue [#2](https://github.com/ArdenIvanov/svelte-intellisense/issues/2) with `:catch` and `:then` svelte syntax auto-insertion
- [Fixed] Issue [#3](https://github.com/ArdenIvanov/svelte-intellisense/issues/3) with `ref:`, `transition:`, `in:`, `out:`, `use:` auto-insertion when user press <kbd>:</kbd>
