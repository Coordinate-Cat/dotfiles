...
var ComponentDataAssignService = /** @class */ (function (_super) {
    __extends(ComponentDataAssignService, _super);
    function ComponentDataAssignService() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ComponentDataAssignService.prototype.getCompletitionItems = function (document, context) {
        ...
        if (match) {
            ...
            if (match[1]) {
                ...
                if (match[3].startsWith('"{') || match[3].startsWith('\'{') || match[3].startsWith('{')) {
                    return document.metadata ? document.metadata.helpers.concat(document.metadata.data, document.metadata.computed) : [];
                }
    ...
    return ComponentDataAssignService;
}(Common_1.BaseService));
exports.ComponentDataAssignService = ComponentDataAssignService;
//# sourceMappingURL=ComponentDataAssignService.js.map