...
var PlaceholdersService = /** @class */ (function (_super) {
    ...
    PlaceholdersService.prototype.getCompletitionItems = function (document, context) {
        ...
        if (/{@[\w\d_]*$/.test(contentPart)) {
            return svelte2Language_1.PlaceholderModifiers;
        }
        var result = [];
        if (document.metadata) {
            result.push.apply(result, document.metadata.data.concat(document.metadata.computed, document.metadata.helpers));
        }
        if (openIndex + 1 === context.offset) {
            result.push.apply(result, svelte2Language_1.PlaceholderModifiers
    ...
    PlaceholdersService.prototype.getDefinition = function (document, context) {
        if (!this.isInsidePlaceholder(context.content, context.offset)) {
            return null;
        }
