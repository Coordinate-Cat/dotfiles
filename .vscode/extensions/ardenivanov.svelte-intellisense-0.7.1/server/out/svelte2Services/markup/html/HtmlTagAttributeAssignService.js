...
var HtmlTagAttributeAssignService = /** @class */ (function (_super) {
        ...
        if (match) {
            ...
            if (match[1]) {
                ...
                if (sourcePropertyName.startsWith('"{') || sourcePropertyName.startsWith('\'{') || sourcePropertyName.startsWith('{')) {
                    return document.metadata ? document.metadata.helpers.concat(document.metadata.computed, document.metadata.data) : [];
                }
            }
        }
        return null;
    ...
    HtmlTagAttributeAssignService.prototype.getDefinition = function (document, context) {
        if (!StringHelpers_1.isInsideAttributeAssign(context.content, context.offset)) {
            return null;
        }
