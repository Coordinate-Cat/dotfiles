...
## Features
![Coverage Gutters features watch](https://github.com/ryanluker/vscode-coverage-gutters/raw/master/promo_images/coverage-gutters-features-1.gif)
...
See [examples directory](https://github.com/ryanluker/vscode-coverage-gutters/blob/master/example) on how to setup a project.

- [Java](https://github.com/ryanluker/vscode-coverage-gutters/blob/master/example/java)
- [PHP](https://github.com/ryanluker/vscode-coverage-gutters/blob/master/example/php)
- [Python](https://github.com/ryanluker/vscode-coverage-gutters/blob/master/example/python)
- [Nodejs](https://github.com/ryanluker/vscode-coverage-gutters/blob/master/example/node)
...
### [Guidelines](https://github.com/ryanluker/vscode-coverage-gutters/blob/master/CONTRIBUTING.md)
